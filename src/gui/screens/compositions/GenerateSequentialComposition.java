...
public class GenerateSequentialComposition extends JFrame {
	 ...
	 * Create the frame.
	 */
	public GenerateSequentialComposition(HashMap<String, TIOSTS> collection, CompositionScreen compositionScreen) {
		setTitle("Generate Sequential Composition");
		...
		btnGenerate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					modelResult = seqComposition.sequentialComposition(spec1, spec2);
