 ...
 */
public class MainChooseRenaming {

	public static void main(String[] args) {
		
		long start = System.currentTimeMillis();
		
		Compiler.compile("./examples/ChooseRenaming.srt", "ChooseRenaming");
		TIOSTS tiostsChoose = Compiler.getSpecification("ChooseRenaming");			
		TIOSTS testPurpose = Compiler.getSpecification("ChooseRenamingTP1");
		...
		try {
			tiostsRen = renOperator.renamingOperator(tiostsChoose, "Cash", "Cheque");
		...
		List<TIOSTS> testCases = symbolrt.generateTestCases(tiostsRen, testPurpose, true);
		
		//Print of ChooseRenaming
