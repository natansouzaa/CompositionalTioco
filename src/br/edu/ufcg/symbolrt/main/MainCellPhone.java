...
public class MainCellPhone {
	...
	public static void main(String[] args) {
		...
		try {
			tiostsHidContactsApp = hidOperator.hidingOperator(tiostsSeqContactsMessage, "DoneContacts");
		} catch (IncompatibleCompositionalOperationException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		TIOSTS tiostsRenMessageApp = null;		
		
		RenamingOperator renOperator = RenamingOperator.getInstance();
		try {
			tiostsRenMessageApp = renOperator.renamingOperator(tiostsReceiveCallApp, "CallSelected", "SELECIONA ESSE TREM");
		} catch (IncompatibleCompositionalOperationException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
